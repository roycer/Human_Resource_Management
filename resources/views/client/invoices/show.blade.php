                            ...
                            <div class="row">
                                <div class="col-md-6 text-left">
                                    <div class="form-group">
                                        <div class="takeLeft">
                                            <div class="radio" >
                                                <input checked onchange="showButton('online')" type="radio" name="method" id="radio13"
                                                       value="high">
                                                <label for="radio13" >
                                                    @lang('modules.client.online') </label>
                                            </div>
                                        </div>

                                        <div class="m-l-20 takeLeft">
                                            <div class="radio takeLeft" >
                                                <input onchange="showButton('offline')"  type="radio" name="method" id="radio15"
                                                       value="low">
                                                <label for="radio15">
                                                    @lang('modules.client.offline') </label>
                                            </div>
                                        </div>
                                    </div>
                                    {{--<div class="clearfix"></div>--}}
                                    <div class="col-md-12 p-l-0 text-left">
                                        @if($invoice->status == 'unpaid' && ($credentials->paypal_status == 'active' || $credentials->stripe_status == 'active'))
                                            <div class="btn-group displayNone" id="onlineBox">
                                                <button aria-expanded="false" data-toggle="dropdown" class="btn btn-info dropdown-toggle waves-effect waves-light button-top" type="button">@lang('modules.invoices.payNow') <span class="caret"></span></button>
                                                <ul role="menu" class="dropdown-menu button-top">
                                            ...
                                            @forelse($methods as $key => $method)
                                                <div class="@if($key != 0) m-l-10 @endif takeLeft">
                                                    <div class="radio radio-info" >
                                                        <input @if($key == 0) checked @endif onchange="showDetail('{!! $method->description !!}')" type="radio" name="offlineMethod" id="offline{{$key}}"
                                                               value="high">
