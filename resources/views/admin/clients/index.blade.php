                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status" id="status" data-style="form-control">
                                    ...
                                    <option value="active">@lang('modules.client.active')</option>
                                    <option value="deactive">@lang('modules.client.deactive')</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">@lang('modules.client.title')</label>
...
//                                    swal("Deleted!", response.message, "success");
            ...
            function loadTable() {
                ...
                table = $('#users-table').dataTable({
                    ...
                    destroy: true,
                    stateSave: true,
                    ajax: '{!! route('admin.clients.data') !!}?client=' + client + '&status=' + status,
                    language: {
