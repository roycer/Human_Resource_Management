                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="paid_on"  id="paid_on" @if(is_null($payment->paid_on)) value="{{ Carbon\Carbon::today()->format('m/d/Y H:i') }}" @else value="{{ $payment->paid_on->format('m/d/Y H:i') }}" @endif>
                                    </div>
                                </div>
