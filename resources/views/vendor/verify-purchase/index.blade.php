<html>
    ...
    <script>
        ...
        const envatoVerify = (purchaseCode) => {
            $.post( "https://worksuite.biz/verify-purchase/verify-envato-purchase.php", { purchaseCode: purchaseCode, domain: "{{ $_SERVER['SERVER_NAME'] }}", itemId: "{{ config('app.envato_item_id') }}", is_ajax: 1 })
                .done(function( data ) {
                    data = $.parseJSON(data);
