                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group pull-right">
                            <a href="{{ route('admin.holidays.calendar') }}" class="btn btn-outline btn-info btn-sm ">@lang('modules.holiday.viewOnCalendar') <i class="fa fa-calendar" aria-hidden="true"></i></a>
                        </div>
    ...
    <script>
       // Delete Holiday
        ...
        function showMarkHoliday() {
            var url = "{{ route('admin.holidays.mark-holiday') }}";
            $.ajaxModal('#edit-column-form', url);
        }
