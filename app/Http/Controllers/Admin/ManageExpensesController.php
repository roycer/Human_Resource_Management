...
class ManageExpensesController extends AdminBaseController
{
    ...
    public function data(Request $request) {
        ...
        $payments = Expense::select('expenses.id', 'expenses.item_name', 'expenses.user_id', 'expenses.price', 'users.name', 'expenses.purchase_date','expenses.currency_id','currencies.currency_symbol','expenses.status' )
    ...
    public function export($startDate, $endDate, $status, $employee) {
        ...
        $payments = Expense::select('expenses.id', 'expenses.item_name', 'expenses.price', 'users.name', 'expenses.purchase_date','expenses.currency_id','currencies.currency_symbol','expenses.status' )
            ->join('users', 'users.id', 'expenses.user_id')
            ->join('currencies', 'currencies.id', 'expenses.currency_id');
        ...
        $exportArray[] = ['ID', 'Item Name','Employee','Status', 'Price', 'Purchase Date'];
