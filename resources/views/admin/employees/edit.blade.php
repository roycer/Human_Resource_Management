                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group"><span class="input-group-addon">@</span>
                                            <input type="text" id="slack_username" name="slack_username"
                                                   ...
                                                   value="{{ $employeeDetail->slack_username or '' }}">
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="joining_date" id="joining_date"
                                               value="{{ $employeeDetail->joining_date->format('m/d/Y') }}"
                                               class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" id="address" rows="5"
                                                  class="form-control">{{ $employeeDetail->address or '' }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="job_title" id="job_title" class="form-control"
                                               value="{{ $employeeDetail->job_title or '' }}">
                                    </div>
                                </div>
                                <!--/span-->
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="hourly_rate" id="hourly_rate" class="form-control"
                                               value="{{ $employeeDetail->hourly_rate or '' }}">
                                    </div>
                                </div>
                                <!--/span-->
                                            ...
                                            <div class="form-group">
                                                @if( $field->type == 'text')
                                                    <input type="text"
                                                           ...
                                                           value="{{$employeeDetail->custom_fields_data['field_'.$field->id] or ''}}">
                                                ...
                                                @elseif($field->type == 'textarea')
                                                    <textarea name="custom_fields_data[{{$field->name.'_'.$field->id}}]"
                                                              ...
                                                              cols="3">{{$employeeDetail->custom_fields_data['field_'.$field->id] or ''}}</textarea>
